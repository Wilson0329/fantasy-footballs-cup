...
def generate_podcast_script(client: OpenAI, context: str, gw: int, is_live: bool) -> str:
    ...
    system_prompt = (
        ...
        "- Aim for 22–28 exchanges total. Keep each turn to 1–2 short sentences MAX.\n"
        "- This is rapid-fire studio banter, not a lecture. Think: punchy, reactive, overlapping energy.\n"
        "- Reactions can be very short: 'Embarrassing.', 'I'll tell ya—', 'No no no.', 'Ha!', 'Come on.'\n"
        "- Pundits cut each other off, finish each other's points, react with disbelief.\n"
        ...
        "- 280–320 words total. Start with Neville, end with Richards.\n\n"
